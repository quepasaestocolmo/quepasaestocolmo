...
export default function Home() {
  return (
    <main style={{fontFamily: 'system-ui, sans-serif', margin: 0, padding: 0}}>
      ...
      {/* NAV */}
      <nav style={{display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '16px 40px', borderBottom: '1px solid #eee', background: 'white'}}>
      ...
      <div style={{position: 'relative', height: '90vh', overflow: 'hidden'}}>
        <img src="/hero.webp .webp" alt="Estocolmo" style={{width: '100%', height: '100%', objectFit: 'cover'}} />
        ...
        <div style={{position: 'absolute', inset: 0, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', padding: '0 20px'}}>
          ...
          <h1 style={{color: 'white', fontSize: 'clamp(36px, 7vw, 80px)', fontWeight: 900, lineHeight: 1.1, margin: '0 0 20px', maxWidth: '800px'}}>
